  ...
  <h3>Foto Pribadi</h3>
    <div class="row">
      <div class="col m3 s12">
        <img src="img/foto_pribadi/1.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col m3 s12">
        <img src="img/foto_pribadi/2.jpg" alt="" class="responsive-img materialboxed">
      </div>
      <div class="col m3 s12">
        <img src="img/foto_pribadi/3.jpeg" alt="" class="responsive-img materialboxed">
     </div>
      <div class="col m3 s12">
        <img src="img/foto_pribadi/4.jpeg" alt="" class="responsive-img materialboxed">
     </div>
    </div>
</div>
</section>
